interface ImportMetaEnv {
  ...
  readonly VITE_ARB_SEPOLIA_CHAIN_ID?: string;
  readonly VITE_ARC_X402_SETTLEMENT_ADDRESS?: string;
  readonly VITE_BASE_SEPOLIA_X402_SETTLEMENT_ADDRESS?: string;
  readonly VITE_ARB_SEPOLIA_X402_SETTLEMENT_ADDRESS?: string;
  readonly VITE_ENABLE_BOTCHAIN_TESTNET?: string;
  readonly VITE_ENABLE_BOTCHAIN_MAINNET?: string;
  readonly VITE_BOTCHAIN_TESTNET_CHAIN_ID?: string;
  readonly VITE_BOTCHAIN_TESTNET_RPC_URL?: string;
  readonly VITE_BOTCHAIN_TESTNET_EXPLORER_URL?: string;
  readonly VITE_BOTCHAIN_TESTNET_USDT_ADDRESS?: string;
  readonly VITE_BOTCHAIN_TESTNET_POLICY_REGISTRY_ADDRESS?: string;
  readonly VITE_BOTCHAIN_TESTNET_X402_LEDGER_ADDRESS?: string;
  readonly VITE_BOTCHAIN_TESTNET_REPUTATION_ADDRESS?: string;
  readonly VITE_BOTCHAIN_MAINNET_CHAIN_ID?: string;
  readonly VITE_BOTCHAIN_MAINNET_RPC_URL?: string;
  readonly VITE_BOTCHAIN_MAINNET_EXPLORER_URL?: string;
  readonly VITE_BOTCHAIN_MAINNET_USDT_ADDRESS?: string;
  readonly VITE_BOTCHAIN_MAINNET_POLICY_REGISTRY_ADDRESS?: string;
  readonly VITE_BOTCHAIN_MAINNET_REPUTATION_ADDRESS?: string;
  readonly VITE_BOTCHAIN_TESTNET_PAYMASTER_RPC_URL?: string;
  readonly VITE_BOTCHAIN_MAINNET_PAYMASTER_RPC_URL?: string;
  readonly VITE_BOTCHAIN_MERIDIAN_NETWORK?: string;
  readonly VITE_BOTCHAIN_USDT_DECIMALS?: string;
  readonly VITE_MERIDIAN_TESTNET_FACILITATOR_ADDRESS?: string;
  readonly VITE_MERIDIAN_MAINNET_FACILITATOR_ADDRESS?: string;
  readonly VITE_NEXORA_BOTCHAIN_MARKETPLACE_FEE_BPS?: string;
  readonly VITE_NEXORA_BOTCHAIN_PLATFORM_FEE_BPS?: string;
